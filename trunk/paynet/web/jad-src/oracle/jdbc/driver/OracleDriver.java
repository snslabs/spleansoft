...
//            OracleDriverExtension, PhysicalConnection, OracleSql, OracleLog, 
//            DatabaseError
    ...
    implements Driver
{
        ...
        throws SQLException
    {
        ...
        driverExtension = driverExtensions[extensionType];
        if(driverExtension == null)
            try
            {
                synchronized(this)
                {
                    if(driverExtension == null)
                    {
                        driverExtension = (OracleDriverExtension)Class.forName(driverExtensionClassNames[extensionType]).newInstance();
                        driverExtensions[extensionType] = driverExtension;
                    } else
                    {
                        driverExtension = driverExtensions[extensionType];
                    }
        ...
        if(useFetchSizeWithLongColumn == null)
            useFetchSizeWithLongColumn = getSystemProperty("oracle.jdbc.useFetchSizeWithLongColumn", null);
        ...
        do
        {
            if(!enumdrivers.hasMoreElements())
                break;
            driverobj = (Driver)enumdrivers.nextElement();
        } while(!(driverobj instanceof OracleDriver));
        do
        {
            if(!enumdrivers.hasMoreElements())
                break;
        ...
        throws SQLException
    {
        if(defaultConn == null || defaultConn.isClosed())
            synchronized(oracle.jdbc.driver.OracleDriver.class)
            {
                if(defaultConn == null || defaultConn.isClosed())
    ...
    private int oracleDriverExtensionTypeFromURL(String url)
    {
        ...
        if(sub_name.equals("thin"))
            return 0;
        return !sub_name.equals("oci8") && !sub_name.equals("oci") ? -3 : 2;
    }
    ...
    public String processSqlEscapes(String sqlString)
        throws SQLException
    {
    ...
    private String parseLoginOption(String user, Properties info)
    {
        ...
        for(i += 4; i < len && lowerCaseUser.charAt(i) == ' '; i++);
        if(i == len)
            return user;
        ...
        throws SQLException
    {
        ...
        int sub_sub_index = url.indexOf(':', url.indexOf(':') + 1) + 1;
        int end = url.length();
        ...
        if(slash <= at_sign && (slash == user || at_sign == user) && at_sign < end)
        {
    ...
    private String[] getSecretStoreCredentials(String connectString)
        throws SQLException
    {
        String userPwd[];
label0:
        {
            ...
            try
            {
                ...
                } while(!alias.startsWith("oracle.security.client.connect_string") || !connectString.equalsIgnoreCase(new String(secretStore.getSecret(alias))));
            ...
            catch(Exception s)
            {
                ...
                {
                    OracleLog.recursiveTrace = true;
                    OracleLog.driverLogger.log(Level.SEVERE, "OracleDriver.getSecretStoreCredentials: Caught exception from wa" +
"llet"
, this);
                    OracleLog.recursiveTrace = false;
                }
    ...
    {
        return "Sat_Feb__2_11:52:05_PST_2008";
    }

    private String translateConnStr(String database)
        throws SQLException
    {
        if(TRACE && !OracleLog.recursiveTrace)
        {
        ...
        if(database == null)
            return database;
        if((fColon = database.indexOf(':')) == -1 || (sColon = database.indexOf(':', fColon + 1)) == -1)
            return database;
    ...
    /**
     * @deprecated Field access_string is deprecated
     */
    public static final String access_string = "access";
    /**
     * @deprecated Field protocolFullName_string is deprecated
     */
    ...
    /**
     * @deprecated Field prefetch_string is deprecated
     */
    public static final String prefetch_string = "prefetch";
    /**
     * @deprecated Field row_prefetch_string is deprecated
     */
    ...
    /**
     * @deprecated Field batch_string is deprecated
     */
    public static final String batch_string = "batch";
    /**
     * @deprecated Field execute_batch_string is deprecated
     */
    ...
    /**
     * @deprecated Field xa_trans_loose is deprecated
     */
    ...
    /**
     * @deprecated Field dataSizeUnitsPropertyName is deprecated
     */
    public static final String dataSizeUnitsPropertyName = "";
    /**
     * @deprecated Field dataSizeBytes is deprecated
     */
    public static final String dataSizeBytes = "";
    /**
     * @deprecated Field dataSizeChars is deprecated
     */
